...
#
# project.tcl: Tcl script for re-creating project 'zynq_serial'
#
...
set orig_proj_dir "[file normalize "$origin_dir/zynq_serial"]"

# Create project
create_project zynq_serial $orig_proj_dir -part xc7z020clg400-1
...
puts "INFO: Project created:zynq_serial"
